...
public interface GanttCategoryDataset extends IntervalCategoryDataset {
	...
	int getPredIntervalCount(Comparable rowKey, Comparable columnKey);

	int getPredIntervalCount(int row, int column);

	Number getStartPredValue(Comparable rowKey, Comparable columnKey,
			int depencyInterval);

	Number getStartPredValue(int row, int column, int depencyInterval);

	int getSubColumnIndex(int row, int column, int subInterval);

	int getPredColumnIndex(int row, int column, int depencyInterval);

	Number getEndPredValue(Comparable rowKey, Comparable columnKey,
			int depencyInterval);

	Number getEndPredValue(int row, int column, int depencyInterval);

	boolean getMilestone(int row, int column);

	int getResourceCount(int row, int column);

	String getResource(int row, int column, int resourceIndex);

//	Task getTask(int row, Comparable taskkey);
