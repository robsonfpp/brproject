...
public class SlidingGanttCategoryDataset extends AbstractDataset
	...
	public int getPredIntervalCount(Comparable rowKey, Comparable columnKey) {
	...
	public int getSubColumnIndex(int row, int column, int subInterval) {
		// TODO Auto-generated method stub
		return 0;
	}

	public int getPredColumnIndex(int row, int column, int depencyInterval) {
		// TODO Auto-generated method stub
		return 0;
	}
